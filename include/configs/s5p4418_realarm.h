...
#define CONFIG_BOOTARGS "console=ttyAMA0,115200 noinitrd root=/dev/mmcblk0p2 rootfstype=ext4 rw init=/linuxrc"
/*-----------------------------------------------------------------------
...
#define	CFG_IO_I2C0_SCL	((PAD_GPIO_C + 16) | PAD_FUNC_ALT0)
#define	CFG_IO_I2C0_SDA	((PAD_GPIO_C + 15) | PAD_FUNC_ALT0)
...
#define CONFIG_ENV_IS_IN_MMC
	...
	#define CONFIG_MMC2_ATTACH      	TRUE//FALSE   /* 2 = MMC2 */
...
#define	FASTBOOT_PARTS_DEFAULT		\
			...
			"flash=mmc,0:userdata:ext4:0x30000000,0x0;"
			

#define CONFIG_ANDROID_PARTS	"setenv fastboot \"flash=mmc,0:2ndboot:2nd:0x200,0x4000;\
flash=mmc,0:bootloader:boot:0x8000,0x70000;\
flash=mmc,0:boot:ext4:0x00100000,0x04000000;\
flash=mmc,0:system:ext4:0x04100000,0x28E00000;\
...
#define CONFIG_LINUX_PARTS	"setenv fastboot \"flash=mmc,0:2ndboot:2nd:0x200,0x4000;\
flash=mmc,0:bootloader:boot:0x8000,0x70000;\
flash=mmc,0:boot:ext4:0x00100000,0x04000000;\
flash=mmc,0:system:ext4:0x04100000,0x28E00000;\
flash=mmc,0:userdata:ext4:0x30000000,0x0;\""								
...
#define CONFIG_CMD_EXT4MKFS
#ifdef CONFIG_CMD_EXT4MKFS
...
//enable LCD 
//#define CONFIG_DISPLAY_OUT_RGB
#define LCD_ENABLE_GPIO					((PAD_GPIO_C + 9) | PAD_FUNC_ALT1)
#define LCD_ENABLE_GPIO_HIGH()			NX_GPIO_SetOutputValue 	(PAD_GET_GROUP(LCD_ENABLE_GPIO), PAD_GET_BITNO(LCD_ENABLE_GPIO), CTRUE )
#define LCD_ENABLE_GPIO_LOW()			NX_GPIO_SetOutputValue 	(PAD_GET_GROUP(LCD_ENABLE_GPIO), PAD_GET_BITNO(LCD_ENABLE_GPIO), CFALSE)
#define LCD_GPIO_ENABLE()				NX_GPIO_SetOutputEnable	(PAD_GET_GROUP(LCD_ENABLE_GPIO), PAD_GET_BITNO(LCD_ENABLE_GPIO), CTRUE )

#define CONFIG_FASTBOOT_SDFUSE
#ifdef CONFIG_FASTBOOT_SDFUSE
#define EMMC_DEV_NUM		0	/* emmc的dev号 */
#define SDFUSE_LOAD_ADDR 	0x48000000/*定义把sd卡中的文件读到内存中的起始地址*/
#define SDFUSE_INTERFACE	"mmc"
#define SDFUSE_DEV_PART		"2:1"
#define CONFIG_eMMC_SD_BLOCK_LEN 512	/* 定义eMMC和SD的block大小为512 Byte*/
#endif

#define CONFIG_CMD_UPDATE_LOGO			/*使能logo升级命令，支持TF卡的logo文件更新到emmc*/
/*-----------------------------------------------------------------------
 * Debug message
 */
...
//#define CONFIG_KEY_BURN_SYSTEM		1
#define CONFIG_UNICODE_GB2132		1
#define CONFIG_REALARM_MENU 		1
