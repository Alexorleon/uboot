...
/////////////////////////////////////////////////////////////////
int make_mmc_partition0(int total_block_count, unsigned char *mbr)
{
...
///////////////////////////////////////////////////////////
	...
	block_offset	= calc_unit(SYSTEM_PART_SIZE, sdInfo);  //系统分区
...
///////////////////////////////////////////////////////////	
	...
	block_offset = calc_unit(BACK_UP_SIZE, sdInfo);  //升级备份
...
/////////////////////////////////////////////////////////// //fat分区 	
	block_start += block_offset;
	block_offset = BLOCK_END;//calc_unit(CACHE_PART_SIZE, sdInfo);
...
///////////////////////////////////////////////////////////	
	...
	encode_partitionInfo(partInfo[2], &mbr[0x1BE]);
...
/////////////////////////////////////////////////////////// //fat分区 	
	...
	make_partitionInfo(block_start, block_offset, sdInfo, &partInfo[2]);*/
///////////////////////////////////////////////////////////	
	block_start = 0x30000000 / 512;
	block_offset = BLOCK_END;  //升级备份
	
	partInfo.bootable	= 0x00;
	partInfo.partitionId	= 0x83;

	make_partitionInfo(block_start, block_offset, sdInfo, &partInfo);
...
/////////////////////////////////////////////////////////////////
int do_mkfs_ext4(cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
	if ( argc != 3 )
	{
...
U_BOOT_CMD(
        ext4mkfs, 3, 0, do_mkfs_ext4,
        "ext4mkfs\t- ext4mkfs for sd/mmc.\n",
        "-c <device_num>\t- create partition.\n"
        "ext4mkfs -p <device_num>\t- print partition information\n"
);
